...
export default function RegisterPage() {
  ...
  return (
    <div className="login">
      <form className="login__box" onSubmit={submit} style={{ width: 480 }}>
        ...
        <p className="muted" style={{ marginTop: "1.2rem" }}>Already have an account? <Link className="linkish" href="/login">Sign in</Link></p>
      </form>
    </div>
  );
}
